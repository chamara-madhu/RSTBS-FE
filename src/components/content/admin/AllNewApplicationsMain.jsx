...
import { ADMIN_REVIEW_APPLICATION_PATH } from "../../../constant/paths";
import { getAllPendingApplications } from "../../../api/applicationAPIs";
import Button from "../../shared/buttons/Button";
import Input from "../../shared/fields/Input";
import moment from "moment";

const AllNewApplicationsMain = () => {
  ...
  const handleReviewClick = (id) => {
    navigate(`${ADMIN_REVIEW_APPLICATION_PATH.replace(":id", id)}`);
  };
...
export default AllNewApplicationsMain;
